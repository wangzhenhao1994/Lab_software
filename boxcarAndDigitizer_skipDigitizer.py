...
class tof_measurement_gui(tof_alignment_gui):
    ...
    def start(self):
        ...
        self.scanNum = 0
        self.cycles = 3320 #72000 correspongind t0 120.5s of measurementF
        ...
        # in case a different measurement is running, do nothing
            ...
            self.measurement = measurement.measurement(
                ...
                sequence=[
                    ...
                    measurement.sleep_function(0.01),#measurement.no_input_sequence_function(self.tof_digitizer.start),
                    measurement.sleep_function(0.01),             
                    measurement.no_input_sequence_function(self.delayer.initWaveGen),#measurement
                    measurement.sleep_function(15),
                    measurement.sleep_function(0.01)#measurement.no_input_sequence_function(self.tof_digitizer.readout_continuous),

...
from nidaqmx_usb6229_fastscan2_ultrafast import PLLreadout_nidaqmx
...
class tof_measurement_gui():
    def __init__(self, doc, running, delayer):
        ...
        self.linePlot_channel5.line(legend='channel5')
        ...
        self.numSweeps = bokeh.models.widgets.TextInput(
            title='Sweep Number', value='360') # number of sweeps
    ...
    def start(self):
        ...
        print('Sweep Time is ' + str(self.sweepTime))
        ...
        # in case a different measurement is running, do nothing
            ...
            self.delayer.setSweepTime(int(self.sweepTime))
            ...
            self.measurement = measurement.measurement(
                inputs=[[None,None,None,self.StartPos] for i in range(int(self.totalScanNum))],#measurement

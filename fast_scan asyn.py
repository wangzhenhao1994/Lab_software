...
class tof_measurement_gui():
    ...
    def start(self):
        ...
        # in case a different measurement is running, do nothing
            ...
            self.measurement = measurement.measurement(
                inputs=[[None,None,self.StartPos] for i in range(int(self.totalScanNum))],#measurement
                ...
                sequence=[
                    ...
                    measurement.sleep_function(11.5),
    ...
    def update(self, data):
        while np.sum(self.nidaq_reader.container) == 0:
            time.sleep(0.1)
        curspec = np.reshape(self.nidaq_reader.container,(10, int(self.sampRate * self.sweepTime)))
